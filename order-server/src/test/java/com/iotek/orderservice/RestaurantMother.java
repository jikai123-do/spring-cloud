...
import com.iotek.orderservice.domain.Address;
import com.iotek.orderservice.domain.Money;
import net.chrisrichardson.ftgo.common.Address;
import net.chrisrichardson.ftgo.common.Money;
import com.iotek.orderservice.domain.MenuItem;
import com.iotek.orderservice.domain.Restaurant;
import com.iotek.orderservice.messaging.RestaurantEventMapper;
...
public class RestaurantMother {
  ...
  public static final Money CHICKEN_VINDALOO_PRICE = new Money("10");
  public static final Address RESTAURANT_ADDRESS = new Address("100", "田林路", "闵行区", "上海市");
